...
| Verified infrastructure version | `0.3.51` |
...
1. `core-aiws` runs at `0.3.51` or newer.
...
selected_skill: productivity / meeting-followup / 0.2.4
selected_action: open_draft
...
actions include: materialize_skill, open_draft, validate_draft, stage_proposal, submit_for_review, refresh_proposal_state, publish_approved_proposal, export_cowork_bridge, delete_old_artifact_dry_run, check_core_update_status
```
