...
- `core-aiws` package version: `0.3.11`
...
2. `core-aiws` is installed and updated to version 0.3.11 or newer.
...
```text
dist/cowork-import/core-aiws-0.3.11.zip
...
Run this in a Cowork chat after updating `core-aiws` to `0.3.11` or later.
...
- `core-aiws-0.3.11.zip` is produced.
