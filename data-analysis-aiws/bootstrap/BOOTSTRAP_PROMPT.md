...
Use this prompt in Claude Code after loading `core-aiws`, `memory-aiws`, and `data-analysis-aiws`:

```text
Validate that the three inline plugins are loaded: core-aiws, memory-aiws, and data-analysis-aiws.
