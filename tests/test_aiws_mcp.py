...
class AiwsMcpSkillTests(unittest.TestCase):
    ...
    def test_clean_machine_has_core_aiws_skills_without_plugins(self) -> None:
        ...
        self.assertIn("Self-Improvement Phase", install)
        self.assertIn("No self-improvement action identified", install)
        ...
        self.assertIn("Self-Improvement Phase", proposal)
        ...
        self.assertIn("Self-Improvement Phase", refresh)
        ...
        self.assertIn("Self-Improvement Phase", update)
        ...
        self.assertIn("Self-Improvement Phase", validation)
        ...
        self.assertIn("Self-Improvement Phase", check)
